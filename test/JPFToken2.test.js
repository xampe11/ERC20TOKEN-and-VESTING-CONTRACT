    ...
    describe("transferFrom", function () {
        ...
        it("Should fail if the sender doesn't have enough tokens", async function () {
            try {
                ...
                console.log("Initial balance of acc:", (await jpfToken.balanceOf(acc.address)).toString());
                console.log("Initial balance of acc2:", (await jpfToken.balanceOf(acc2.address)).toString());
